pipeline {
    ...
    environment {
        ...
        MONGOEXPRESS_LOGIN="${ME_CONFIG_BASICAUTH_USERNAME}"
        MONGOEXPRESS_PASSWORD="${ME_CONFIG_BASICAUTH_PASSWORD}"
            ...
            steps {
                script {
                    sshagent(['deploy-ssh']) {
                        ...
                        export MONGOEXPRESS_LOGIN="${ME_CONFIG_BASICAUTH_USERNAME}" &&
                        export MONGOEXPRESS_PASSWORD="${ME_CONFIG_BASICAUTH_PASSWORD}" &&
